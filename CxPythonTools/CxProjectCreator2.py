...
def main():
    ...
    try:
        ...
        print("%s The Checkmarx Project 'creation' via Rest API #2 is starting execution from Server [%s] on [%s] under Python [%s]..." % (sScriptDisp, sServerNode, sDTNowStamp, sPythonVers));
        print("");
        ...
        optParser.add_option("-p", "--file-patterns", dest="file_patterns", default="*.properties", help="File 'patterns' to search for (semicolon delimited) [default is '*.properties']", metavar="FILE-PATTERNS");
    ...
    # TEMP:
        ...
        print("");
        print("%s The Checkmarx Project 'creation' via Rest API #2 is ending execution from Server [%s] on [%s] under Python [%s]..." % (sScriptDisp, sServerNode, sDTNowStamp, sPythonVers));
        print("");
